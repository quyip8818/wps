...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
        ...
        public function notices() {
            ...
            if ( ! empty( $message ) ) {
                ...
                foreach ( $message as $type => $plugin_group ) {
                    ...
                    $linked_plugins = array_map( array( 'TGMA_Utils', 'wrap_in_em' ), $linked_plugins );
        ...
        public function register( $plugin ) {
            ...
            $plugin['required']           = TGMA_Utils::validate_bool( $plugin['required'] );
            $plugin['force_activation']   = TGMA_Utils::validate_bool( $plugin['force_activation'] );
            $plugin['force_deactivation'] = TGMA_Utils::validate_bool( $plugin['force_deactivation'] );
        ...
        public function process_bulk_actions() {
            ...
            if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    $plugin_names = array_map( array( 'TGMA_Utils', 'wrap_in_strong' ), $plugin_names );
