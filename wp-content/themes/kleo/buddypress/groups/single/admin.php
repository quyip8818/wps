  ...
  <div class="gap-60"></div>
    ...
    <div class="hr-title hr-full"><abbr><?php _e( 'Administrators', 'buddypress' ); ?></abbr></div>
		...
		<ul id="admins-list" class="item-list single-line">
			...
			<li>
				<?php echo bp_core_fetch_avatar( array( 'item_id' => bp_get_member_user_id(), 'type' => 'thumb', 'width' => 50, 'height' => 50, 'alt' => sprintf( __( 'Profile picture of %s', 'buddypress' ), bp_get_member_name() ) ) ); ?>
				<h5>
